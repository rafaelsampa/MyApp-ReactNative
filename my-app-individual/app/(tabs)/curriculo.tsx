  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.projectCard}>
        {}
        {}
        <Text style={styles.projectTitle}>Monitor de Infraestrutura de Software</Text>
        <Text style={styles.text}>
          Participei como Tutor academico da disciplina de Infraestrutura de software durante 2024.2 e 2025.1
        </Text>
        <Text style={styles.techs}>SO | Tutoria Acadêmica</Text>
      </View>
    </ScrollView>
  );
}
